...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "ClusteredDeferredRenderer", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------
    Shader shader("shaders/render.vert", "shaders/render.frag");

    ModelLoader loader;
    std::cout << "Loading model..." << std::endl;
    std::vector<Mesh> meshes = loader.loadModel("assets/models/shiba/scene.gltf");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 globalNormalization = glm::scale(glm::mat4(1.0f), glm::vec3(scale));

// Flip from Z-up to Y-up or vice versa
        glm::mat4 axisCorrection = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));

        globalNormalization = axisCorrection * globalNormalization;
        globalNormalization = glm::translate(globalNormalization, -center);
...
//        shader.setMat4("model", model);
        ...
        {
            glm::mat4 model = globalNormalization * mesh.modelMatrix;
            shader.setMat4("model", model);
            ...
            glBindTexture(GL_TEXTURE_2D, mesh.specularGlossinessTextureID);
